...
def main():
    ...
    with col1:
        ...
        st.info(
            "Navigate to the **Wise** page in the sidebar to view your banking dashboard."
        )
    ...
    with col2:
        ...
        st.info(
            "Navigate to the **Pensions** page in the sidebar to view your pension dashboard."
        )
    ...
    **For Pensions Data:**
    ...
    with st.expander("System Information"):
        try:
            ...
            st.error(
                "Configuration not found. Please ensure `configuration/secrets.py` is set up."
            )
